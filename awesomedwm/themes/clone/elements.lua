...
theme.border_normal = gmc.color['black']   .. "cc"
theme.border_focus  = gmc.color['grey500']    .. "cc"
...
theme.taglist_bg_focus = gmc.color['grey200'] .. "cc"
