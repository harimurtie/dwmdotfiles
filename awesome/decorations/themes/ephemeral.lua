...
--            decorations.text_button(c, "", "Material Icons 13", x.color1, gen_button_color_unfocused, x.color9, gen_button_size, gen_button_margin, "close"),
            decorations.text_button(c, "", "Material Icons 11", x.color7, gen_button_color_unfocused, x.color11, gen_button_size, gen_button_margin, "ontop"),
            decorations.text_button(c, "", "Material Icons 11", x.color7, gen_button_color_unfocused, x.color11, gen_button_size, gen_button_margin, "sticky"),
            decorations.text_button(c, "", "Material Icons 11", x.color7, gen_button_color_unfocused, x.color11, gen_button_size, gen_button_margin, "minimize"),
            decorations.text_button(c, "", "Material Icons 11", x.color7, gen_button_color_unfocused, x.color10, gen_button_size, gen_button_margin, "maximize"),
            decorations.text_button(c, "", "Material Icons 11", x.color7, gen_button_color_unfocused, x.color9, gen_button_size, gen_button_margin, "close"),
