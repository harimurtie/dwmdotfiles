...
--          window_switcher_show(awful.screen.focused())
    ...
    awful.key({ superkey }, "space",
        function()
            awful.spawn.with_shell("~/Documents/scripts/dmenu_mager")
        end,
        {description = "rofi launcher", group = "launcher"}),
    awful.key({ superkey }, "c",
        function()
            awful.spawn.with_shell("~/Documents/scripts/kopi")
        end,
        {description = "rofi launcher", group = "launcher"}),
    ...
    awful.key({ }, "Print",
        function()
            awful.spawn.with_shell("~/Documents/scripts/screenshot.sh")
        end,
        {description = "rofi launcher", group = "launcher"}),
    awful.key({ superkey }, "Print",
        function()
            awful.spawn.with_shell("~/Documents/scripts/screenshot.sh -s")
        end,
        {description = "rofi launcher", group = "launcher"}),
