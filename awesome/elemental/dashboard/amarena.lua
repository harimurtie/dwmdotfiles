...
local user_box = create_boxed_widget(user_widget, dpi(300), dpi(490), x.background)
...
local bookmarks_box = create_boxed_widget(bookmarks, dpi(200), dpi(490), x.background)
