...
cpu:buttons(
    gears.table.join(
        ...
        awful.button({ }, 1, apps.process_monitor_gui)
))
...
--sidebar.width = beautiful.sidebar_width or dpi(500)
sidebar.width = dpi(320)
...
--awful.placement.maximize_vertically(sidebar, { honor_workarea = false, margins = { top = beautiful.useless_gap } })
