...
apps.telegram = function ()
    helpers.run_or_raise({class = 'TelegramDesktop'}, false, "telegram-desktop", { switchtotag = false })
end
...
--    helpers.run_or_raise({class = 'Steam'}, false, "steam")
    awful.spawn.with_shell("~/Documents/scripts/start-jack.sh")
end
apps.lutris = function ()
--    helpers.run_or_raise({class = 'Lutris'}, false, "lutris")
    awful.spawn.with_shell("~/Documents/scripts/stop-jack.sh")
end
apps.discord = function ()
--    helpers.run_or_raise({class = 'Lutris'}, false, "lutris")
    awful.spawn.with_shell("~/bin/decorate_terminal")
end
apps.youtube = function ()
    awful.spawn.with_shell("rofi_mpvtube")
end
apps.networks = function ()
    awful.spawn.with_shell("~/Documents/scripts/koneksi")
end
...
apps.compositor = function ()
    awful.spawn.with_shell("~/Documents/scripts/compton-toggle.sh")
...
apps.record = function ()
    awful.spawn.with_shell("~/Documents/scripts/ssrt")
end
