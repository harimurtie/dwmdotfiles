...
user = {
    ...
    terminal = "xst",
    floating_terminal = "xst",
    browser = "qutebrowser",
    file_manager = "kitty -1 -e ranger",
    editor = "kitty -1 -e vim",
    email_client = "kitty -1 -e neomutt",
    music_client = "kitty -1 --single-instance --class music -e ncmpcpp",
    ...
    dirs = {
        ...
        music = os.getenv("XDG_MUSIC_DIR") or "~/Music/mix",
        pictures = os.getenv("XDG_PICTURES_DIR") or "~/Pictures",
        videos = os.getenv("XDG_VIDEOS_DIR") or "~/Videos",
        wallpapers = os.getenv("XDG_WALLPAPER_DIR") or "~/Pictures/wal",
...
local floating_client_placement = function(c)
    ...
    return p(c, {honor_padding = true, honor_workarea=true, margins = beautiful.useless_gap * 5})
end
